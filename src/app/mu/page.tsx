                ...
                <div className="flex justify-between items-center mt-1">
                  ...
                  <div className="flex gap-1">
                    ...
                    <button 
                      ...
                      className={`w-8 h-8 border-2 rounded-lg flex items-center justify-center text-sm transition-all active:scale-90 flex-shrink-0 ${
                        b.state.spawnTime === -1 ? 'bg-slate-700 border-slate-600 grayscale opacity-50' : 'bg-rose-500/10 hover:bg-rose-500/30 border-rose-500/50'
                      }`}
                    >
                      💀
                    </button>
